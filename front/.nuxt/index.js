...
import NuxtError from '../views/layouts/error.vue'
...
import nuxt_plugin_authInit_4870e84e from 'nuxt_plugin_authInit_4870e84e' // Source: ../plugins/authInit (mode: 'all')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (typeof nuxt_plugin_plugin_6fd15fee === 'function') {
    await nuxt_plugin_plugin_6fd15fee(app.context, inject)
  }

  if (typeof nuxt_plugin_plugin_b804ca80 === 'function') {
    await nuxt_plugin_plugin_b804ca80(app.context, inject)
  }
  ...
  if (typeof nuxt_plugin_authInit_4870e84e === 'function') {
    await nuxt_plugin_authInit_4870e84e(app.context, inject)
  }

  if (typeof nuxt_plugin_httpInit_29b8b9a4 === 'function') {
    await nuxt_plugin_httpInit_29b8b9a4(app.context, inject)
  }
